...
//TODO all components and functions should be part of or their own browserify module?

//http://stackoverflow.com/questions/149055/how-can-i-format-numbers-as-money-in-javascript
var money_formatter = (number) => {
    //KU is an imaginary currency symbol
    return "KU " + number.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,');
};

var Item = React.createClass({
    //TODO should be able to take a lot of these style attributes as optional props
    styles: {
        container: {
            'width': '80%',
            'height': '300px',
...
//TODO get from ajax call, render spinner component while waiting for response
var impossible_items = [
    {
        name: "Magic Wand",
...
React.render(<ImpossibleStore items={impossible_items}/>, document.getElementById('impossiblestore'));
