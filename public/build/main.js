...
var ImpossibleStore = (function () {
    ...
    return React.createClass({
        ...
        previous_click: function previous_click(e) {
            e.preventDefault();
            index = index !== 0 ? index - 1 : index;
            this.setState({ current_item: items[index] });
        },
        next_click: function next_click(e) {
            e.preventDefault();
        ...
        render: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    null,
                    "Price: ",
                    format_as_money(this.state.current_item.price)
                ),
                React.createElement(
                    "div",
                    null,
                    "Brand: ",
                    this.state.current_item.brand
                ),
                React.createElement(
                    "div",
                    null,
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "a",
                        { href: "", className: "previous", onClick: this.previous_click },
                        "previous"
                    ),
                    React.createElement(
                        "a",
                        { href: "", className: "next", onClick: this.next_click },
                        "next"
                    )
                )
            );
